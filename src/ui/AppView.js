...
export class AppView {
  ...
  enterFinalWorld(world, salon = this.currentSalon, provider = this.conceptProvider) {
    ...
    lookback.append(
      company,
      element("p", {}, "Your whole company turns toward you as the worlds you crossed settle into one answer."),
      element("strong", {}, `QUESTION EXPLORATION COMPLETE · ${finalProgress.explored} / ${finalProgress.total} WORKS · ${finalProgress.worldsExplored} / ${finalProgress.worldsTotal} WORLDS`)
    );
    this.presentEntry("final-answer", [
      ...
      element("p", { className: "entry-copy" }, "Your company turns toward you in the Shimmering Spheres. The works fall away; what remains is the question you carried and the answer you formed together."),
      lookback,
  ...
  renderAtlas(context) {
    ...
    this.drawerBody.replaceChildren(
      element("p", { className: "drawer-note" }, answerOpen
        ...
        : "All eight worlds are available. Move freely, linger with a work, or jump ahead; your question progress remains intact."),
      grid
    );
  }
  ...
  renderEvidence(context) {
    ...
    const rows = [
      ...
      ["Canonical process", "8 freely navigable worlds"],
